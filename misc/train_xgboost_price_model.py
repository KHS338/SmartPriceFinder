...
def prepare_features(df):
    ...
    print("\n[i] Preparing features for XGBoost training...")
...
def save_model(model, label_encoders, feature_cols, metrics):
    ...
    model_package = {
        ...
        'version': '1.0',
        'algorithm': 'XGBoost',
        'description': 'XGBoost price prediction model with gradient boosting'
    }
...
def main():
    ...
    print("="*60)
    print("XGBoost Price Prediction Model Training")
